...
** Using multi-thread to do performance improvement
   - first version (commit 3a8cc27)
     ...
     profiling file: profile_recursive_single_thread.html
   ...
   - replace recursive with iterative
       N=15, Solution size=18752, Time (seconds):16.993933001
     performance drops due to ArrayList deep copy.
     profiling file: profile_iterative_1st.html

   - iterative with boolean array in vertical validation (commit:b1bdbe1e)
       N=15, Solution size=18752, Time (seconds):13.324033833
     profiling file: profile_iterative_2st_use_boolean_array_in_vertical_valid.html
